<html lang="en" class="">
   <head>
      ...
      <script src="https://cdnjs.cloudfare.com/ajax/libs/handlebars.js/4.7.6/handlebars.min.js"></script>
               ...
               <div class="layout_wrapper">
                  ...
                  <div class="layout_footer">
                     <div class="section section--search">
                        <form class="form form--search-form"><input placeholder="Search users"></form>
                     </div>
                     <div class="section">
                        ...
                        <div class="section_block section_block--content">
                           <ul class="nav">
                              <li class="nav_item"><a class="nav_link" href="#/search/India/1"><span class="nav_link_text nav_link_text--primary">#India</span><span class="nav_link_text nav_link_text--secondary"></span></a></li>
                              <li class="nav_item"><a class="nav_link" href="#/search/Walk/1"><span class="nav_link_text nav_link_text--primary">#Walk</span><span class="nav_link_text nav_link_text--secondary"></span></a></li>
                              <li class="nav_item"><a class="nav_link" href="#/search/What/1"><span class="nav_link_text nav_link_text--primary">#What</span><span class="nav_link_text nav_link_text--secondary"></span></a></li>
                           </ul>
                        </div>
                     </div>
                     <div class="section">
                        ...
                        <div class="section_block section_block--content">
                           <p>Twitter is a free social networking site where users broadcast short post known as tweets.</p>
                        </div>
                     </div>
                     <div class="section">
                        <div class="section_block section_block--content">Hey Everyone!</div>
                     </div>
                  </div>
               </div>
            </div>
